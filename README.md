[![Run App Jay Patel](https://github.com/jpatel9/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jpatel9/GithubActions/actions/workflows/run-app.yaml)
